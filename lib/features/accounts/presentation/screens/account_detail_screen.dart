    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          _buildDetailRow(
            'Fecha de corte',
            account.fechaCorte != null ? 'Día ${account.fechaCorte} de cada mes' : 'No configurada',
            isDark,
          ),
          const Divider(height: 24),
          _buildDetailRow(
            'Fecha límite pago',
            account.fechaLimitePago != null ? 'Día ${account.fechaLimitePago} del mes sig.' : 'No configurada',
            isDark,
          ),
          const Divider(height: 24),
